...
import 'package:tool_bag/database/db_helper.dart';
import 'package:tool_bag/models/contact.dart';
...
class _AddContactFormState extends State<AddContactForm> {
                        ...
                        if (_formKey.currentState.validate()) {
                          ...
                          var snackBar = Scaffold.of(context).showSnackBar(
                            SnackBar(
                                ...
                                content:
                                    Text("${contact.name} has been saved")),
                          );
  ...
  _onShareData(BuildContext context) async {
    ...
    await Share.share("${contact.name}: ${contact.phoneNumber}",
        subject: contact.phoneNumber,
